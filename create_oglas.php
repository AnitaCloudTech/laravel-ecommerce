        ...
        <div class="container">
            <div class="wrapper">
                    <div class="loginRegisterRedirect" style="justify-content: center;">
                        <button class ="loginRegisterRedirectButton" onclick="location.href = 'pocetna.php';">Vrati se</button>
                    </div>
                <form action="create_oglas.php" method="post" enctype="multipart/form-data">
                    <div class="formOglas">
                        <label for="photo">Učitaj sliku:</label>
                    ...
                    <input type="text" name="title" id="title" required placeholder="Naslov" class="inputLogRes"><br>
                    <input type="text" name="cost" id="cost" placeholder="Price" class="inputLogRes"><br>
            
            
                    <textarea name="description" id="description" rows="4" required placeholder="Opis oglasa" class="inputLogRes"></textarea><br>
                
                    <input class="startPageBttn" type="submit" value="Objavi" name="submitOglas">
                </form>
            </div>
        </div>
    </body>
