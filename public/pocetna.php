...
<body>
    ...
    <div class="container" style="width:75%; flex:1">
        ...
        // Add LIMIT + OFFSET for actual fetch
    ...
    <footer class="siteFooter">
        <div class="footerContent">
            <div class="footerLeft">
                <img src="uploads\logoFiniOglasi.png" alt="Logo" style = "width: 300px; height: 80px;">
                <p style = "margin-left: 10px;">&copy; <?php echo date("Y"); ?> FiniOglasi.rs — Sva prava zadržana</p>
            </div>
            <div class="footerRight" style = "margin-right: 30px;">
                <div class="socialIcons" style = "padding-bottom: 20px;">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="#"><i class="fab fa-twitter"></i></a>
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
                <a href="terms.php">Uslovi korišćenja</a>
